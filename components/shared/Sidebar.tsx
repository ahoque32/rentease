    ...
    <div className="fixed inset-y-0 left-0 z-50 w-64 border-r border-white/30 bg-white/70 backdrop-blur-xl shadow-lg shadow-black/5">
      ...
      <div className="border-t border-white/30 p-4">
        <form action="/auth/signout" method="post">
          <button
            type="submit"
            className="flex w-full items-center justify-center gap-2 rounded-lg border border-white/40 bg-white/70 px-4 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-white/90"
          >
            Sign Out
          </button>
        </form>
